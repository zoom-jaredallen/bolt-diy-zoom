      ...
      >
        <div className="h-12 flex items-center justify-between px-4 border-b border-bolt-elements-borderColor bg-bolt-elements-background-depth-2 rounded-tr-2xl">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center justify-center w-[32px] h-[32px] overflow-hidden bg-bolt-elements-background-depth-2 text-bolt-elements-textSecondary rounded-full shrink-0">
              {profile?.avatar ? (
                <img
                  src={profile.avatar}
        ...
        <div className="flex-1 flex flex-col h-full w-full overflow-hidden">
          <div className="p-4 space-y-3">
            <div className="flex gap-2">
              ...
              <button
                ...
                className={classNames(
                  ...
                  selectionMode
                    ? 'bg-bolt-elements-button-primary-text text-white border border-bolt-elements-borderColorActive'
                    : 'bg-bolt-elements-background-depth-2 text-bolt-elements-textSecondary hover:bg-bolt-elements-item-backgroundActive border border-bolt-elements-borderColor',
                )}
            ...
            <div className="relative w-full">
              ...
              <input
                className="w-full bg-bolt-elements-background-depth-2 relative pl-9 pr-3 py-2 rounded-lg focus:outline-none focus:ring-1 focus:ring-bolt-elements-borderColorActive text-sm text-bolt-elements-textPrimary placeholder-bolt-elements-textTertiary border border-bolt-elements-borderColor"
                type="search"
